...
valor da hora trabalhada: 25
imposto: 0.125
salario bruto: valor da hora trabalhada * horas trabalhada simpostos a cobrar: salario bruto * impostos a cobrar
salario liquido: salario bruto - impostos a cobrar
...
imposto = 0.125
salário_bruto = valor_ da _hora_trabalhada * horas_trabalhadas 
print(f"\t\tSalário Bruto: R${salário_bruto:.2f}")
imposto_a_cobrar = salário_bruto * imposto
print(f"\t\tImposto: R${imposto_a_cobrar:.2f}")
salário_liquido = salário_bruto - imposto_a_cobrar
